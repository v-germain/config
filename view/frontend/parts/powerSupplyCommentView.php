...
<div class="viewPart">
    ...
    <form method="POST" class="form comment" action="index.php?action=addCommentAlimentation">
    ...
    while ($comment = $comments->fetch()) {
        ...
        <div class="comments">
            ...
            <?php if (isset($_SESSION['pseudo']) and ($_SESSION['pseudo']) == 'admin') : ?>
                <a href="index.php?action=delComment&amp;id=<?= $comment['idComment'] ?>&amp;idPart=<?= $partData['id'] ?>&amp;type=3" class="btn btn-danger">Supprimer</a>
            <?php endif; ?>
        </div>
    <?php
