...
<div class="viewPart">
    ...
    <div class="card" style="width: 40rem;">
        <img src="public/images/disquedur/<?= $partData['id'] ?>.jpg" class="card-img-top" alt="Disque dur <?= $partData['name'] ?>">
        <div class="card-body">
    ...
    <form method="POST" class="form comment" action="index.php?action=addCommentDisqueDur">
    ...
    while ($comment = $comments->fetch()) {
        ...
        <div class="comments">
            ...
            <?php if (isset($_SESSION['pseudo']) and ($_SESSION['pseudo']) == 'admin') : ?>
                <a href="index.php?action=delComment&amp;id=<?= $comment['idComment'] ?>&amp;idPart=<?= $partData['id'] ?>&amp;type=6" class="btn btn-danger">Supprimer</a>
            <?php endif; ?>
        </div>
    <?php
