...
<div class="viewPart">
    ...
    <div class="card" style="width: 40rem;">
        <img src="public/images/boitier/<?= $partData['id'] ?>.jpg" class="card-img-top" alt="Boitier <?= $partData['name'] ?>">
        <div class="card-body">
    ...
    while ($comment = $comments->fetch()) {
        ...
        <div class="comments">
            ...
            <?php if (isset($_SESSION['pseudo']) and ($_SESSION['pseudo']) == 'admin') : ?>
                <a href="index.php?action=delComment&amp;id=<?= $comment['idComment'] ?>&amp;idPart=<?= $partData['id'] ?>&amp;type=4" class="btn btn-danger">Supprimer</a>
            <?php endif; ?>
        </div>
    <?php
