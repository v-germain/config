...
<head>
  ...
  <meta name="description" content="Descriptions de matériel informatique orienté gaming, prix et détails techniques des composants suivants : processeur, carte mère, mémoire, carte graphique, alimentation, disque dur, boitier etc. Possibilité d'inscription et de commenter/discuter des différents produits décrits sur le site." />
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <nav class="navbar navbar-light bg-light">
        <a class="navbar-brand" href="index.php?action=listConfig">
          <img src="/pro5/public/images/icon.jpg" width="100" height="70" alt="icone du site">
        </a>
      </nav>
